...
const getAsync = (url, options = {}) => {
  return internalFetch(url, { ...options, method: "GET" });
};

const getWithUrlAsync = (url, options = {}) => {
  return internalFetchWithUrl(url, { ...options, method: "GET" });
};
